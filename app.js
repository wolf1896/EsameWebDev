document.addEventListener("DOMContentLoaded", () => {
    ...
    if (window.location.pathname.includes("discover.html")) {
        ...
        function loadRecipes(query = "", type = "name") {
            ...
            // By default, an empty query string ("") in TheMealDB search returns a broad list of recipes
            let apiUrl = `https://www.themealdb.com/api/json/v1/1/search.php?s=${query}`;
            
            // Only switch to ingredient filter if the user actually typed an ingredient
